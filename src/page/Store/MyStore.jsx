    ...
    useEffect(() => {
        const fetchStoreData = async () => {
            try {
                ...
                let addressJSON = JSON.parse(response.data.address);
                response.data.address = addressJSON.address;
                response.data.city = addressJSON.city;
                response.data.state = addressJSON.state;
                response.data.country = addressJSON.country;
                response.data.zip_code = addressJSON.zip_code;
                    ...
                    <div className="card mb-4">
                        <Tabs
                            ...
                            items={[
                                {
                                    label: 'Details',
                                    icon: <i className="fa-sharp fa-regular fa-address-card"></i>,
                                    key: '1',
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="mb-3 col-md-6">
                                                    ...
                                                    >
                                                        ...
                                                        <option value="stock">Notification when stock is updated
                                                        </option>
                                                        <option value="store">Notification when store is updated
                                                        </option>
                                                ...
                                                <div className="mb-3 col-md-6">
                                                    ...
                                                    >
                                                        <option value='order'>Send Mail when new order is created
                                                        </option>
                                                        <option value="payment">Send Mail when payment is received
                                                        </option>
                                                        <option value="customer">Send Mail when new customer is added
                                                        </option>
                                                        <option value="product">Send Mail when new product is added
                                                        </option>
                                                ...
                                                <div className="mb-3 col-md-6">
                                                    ...
                                                    >
                                                        <option value='order'>Send SMS when new order is created
                                                        </option>
                                                        <option value="payment">Send SMS when payment is received
                                                        </option>
                                                        <option value="customer">Send SMS when new customer is added
                                                        </option>
                                                        <option value="product">Send SMS when new product is added
                                                        </option>

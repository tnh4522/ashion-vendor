// src/components/Products/components/InventoryDetails.jsx

import React from 'react';
import { Input, Row, Col, Select, Typography, Table, InputNumber, message } from 'antd';
...
const InventoryDetails = ({
    ...
    const stockDetailColumns = [
        ...
        // Cột "Variant Image" đã bị loại bỏ
    ];
